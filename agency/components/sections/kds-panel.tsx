...
/* Panel KDS: capa de presentación reusable con referencias externas.
 * Los enlaces a proveedores son informativos; no implican integración técnica ni afiliación.
 */
const panelVariants = {
  hidden: {},
  show: {
