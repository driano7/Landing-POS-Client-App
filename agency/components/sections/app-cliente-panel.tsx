...
/* Panel de producto mixto: shell reusable + copy funcional del cliente.
 * Cualquier afirmación sobre datos, pagos o privacidad debe validarse con el contrato y la implementación real.
 */
const panelVariants = {
  hidden: {},
  show: {
