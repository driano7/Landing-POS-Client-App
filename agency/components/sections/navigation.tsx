...
import { ThemeToggle } from "@/agency/components/theme-toggle"
import { WhatsAppCTAButton } from "@/terceros/components/ui/whatsapp-cta"
import { motion } from "framer-motion"
import { useEffect, useState } from "react"
import { LanguageSwitcher } from "@/agency/components/language-switcher"
import { useLocale } from "@/agency/components/locale-provider"

/* Navegación compartida del sitio.
 * Los enlaces y CTAs cambian por idioma, pero la estructura del header/mobile dock es reusable.
 */
const navCopy = {
  es: {
    navLinks: [
