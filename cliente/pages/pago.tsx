 ...
 * La demo de checkout no procesa pagos reales; cualquier integración futura requerirá revisión legal/contractual.
...
import { FlipCard, detectCardBrand, type CardBrand } from "@/agency/components/payment/flip-card"
import { TypingText } from "@/agency/components/ui/typing-text"

/* Demo visual de checkout.
 * Esta página no mueve dinero ni se conecta a un procesador; solo muestra interacción y estados de UI.
 */
